...
const Footer = () => {
  return (
    <footer className="bg-zinc-800/50 border-t border-zinc-700/50 py-8 lg:py-12">
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center gap-6 reveal-up">
            <div className="flex items-center gap-4">
              {socials.map(({ label, href, icon }, key) => (
                <a
                  ...
                  href={href}
                  target="_blank"
                  className="w-12 h-12 grid place-items-center text-zinc-400 transition-colors hover:text-zinc-200"
                  title={label}
                >
                  {icon}
                </a>
            ...
            <p className="text-zinc-500 text-lg">
              &copy; 2025 <span className="text-zinc-200">Abeih Hamani</span>
            </p>
          </div>
        </div>
      </div>
